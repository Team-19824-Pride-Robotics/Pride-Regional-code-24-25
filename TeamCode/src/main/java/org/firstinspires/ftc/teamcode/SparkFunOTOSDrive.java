...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        // would be {-5, 10, -90}. 40.5These can be any value, even the angle can be
        // tweaked slightly to compensate for imperfect mounting (eg. 1.3 degrees).

        // RR localizer note: These units are inches and radians.
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(0, 0, Math.toRadians(-1.5));
        ...
        public double angularScalar = 1.0974;
    }
